...
export default function NumberItem({ account, isOwner, is_followed }: ViewProps) {
    ...
    return (
        <>
            <div
                className="flex items-center justify-between bg-gray-800 rounded-lg px-4 py-3 mb-1 shadow"
            >
                <div className="flex items-center  gap-3">
                    ...
                    />
                    <span className="text-md font-semibold text-gold-400 flex-wrap">{account?.name}</span>
                    {isOwner &&

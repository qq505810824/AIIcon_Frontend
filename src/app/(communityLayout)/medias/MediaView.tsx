...
export default function MediaView({ handleRefresh, medias, hasSelectedMedias, onConfirm }: ViewProps) {
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex justify-between items-center  flex-wrap space-y-2 mb-8">
                        <div className=" ">
                            ...
                            <p className="text-gray-300">Explore media outlets by city and industry</p>
                        </div>
                        <button
                            onClick={() => {
                                onSubmit()
